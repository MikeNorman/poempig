"""
Simple ingestion script that works with basic table schema
"""
...
def main():
    ...
    ap.add_argument("--source",default="Simple Ingest v1")
    ...
    for ln in tqdm(lines, desc="Ingest"):
        ...
        # Simple row structure that should work with basic table
        row={
            "title": title,
